...
using Bizomet.Data.DataEncryption.Internal;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
using Microsoft.EntityFrameworkCore.Storage.ValueConversion;

namespace Bizomet.Data.DataEncryption
{
	/// <summary>
	...
	public static class PropertyBuilderExtensions
	{
		...
		/// <paramref name="format"/> is not a recognized value.
		/// </exception>
		public static PropertyBuilder<byte[]> IsEncrypted(this PropertyBuilder<byte[]> property, IEncryptionProvider encryptionProvider, StorageFormat format = StorageFormat.Default, ConverterMappingHints mappingHints = null)
		{
			if (property is null)
			{
		...
		/// <paramref name="format"/> is not a recognized value.
		/// </exception>
		public static PropertyBuilder<string> IsEncrypted(this PropertyBuilder<string> property, IEncryptionProvider encryptionProvider, StorageFormat format = StorageFormat.Default, ConverterMappingHints mappingHints = null)
		{
			if (property is null)
			{
				throw new ArgumentNullException(nameof(property));
		...
		/// <paramref name="format"/> is not a recognized value.
		/// </exception>
		public static PropertyBuilder<SecureString> IsEncrypted(this PropertyBuilder<SecureString> property, IEncryptionProvider encryptionProvider, StorageFormat format = StorageFormat.Default, ConverterMappingHints mappingHints = null)
		{
			if (property is null)
			{
				throw new ArgumentNullException(nameof(property));
