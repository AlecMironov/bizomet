...
namespace Bizomet.Data.DataEncryption.Internal
{
	...
	internal sealed class EncryptionConverter<TModel, TProvider> : ValueConverter<TModel, TProvider>, IEncryptionValueConverter
	{
		...
		/// </summary>
		public EncryptionConverter(IEncryptionProvider encryptionProvider, Expression<Func<TModel, TProvider>> convertToProviderExpression, Expression<Func<TProvider, TModel>> convertFromProviderExpression, ConverterMappingHints mappingHints = null)
