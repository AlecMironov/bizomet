...
namespace Bizomet.Data.DataEncryption.Internal
{
	/// <summary>
	...
	public static class ConverterBuilder
	{
		...
		/// </exception>
		public static ConverterBuilder<TModelType> From<TModelType>(this IEncryptionProvider encryptionProvider, Func<TModelType, byte[]> decoder, Func<Stream, TModelType> encoder)
		{
			if (decoder is null) {
		...
		/// </exception>
		public static ConverterBuilder<TModelType, TStoreType> To<TModelType, TStoreType>(ConverterBuilder<TModelType> modelType, Func<TStoreType, byte[]> decoder, Func<Stream, TStoreType> encoder)
		{
