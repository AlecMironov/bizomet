...
namespace Bizomet.Data.Migrations
{
	...
	[Migration("20220419020211_2022.00.00.23")]
	partial class _2022000023
	{
			...
			modelBuilder.Entity("Bizomet.Data.Entities.ApplicationRole", b =>
				{
					...
					b.HasData(
						new
						{
							...
							ConcurrencyStamp = "177f8adc-5bde-4721-8f2f-1b44d0d6cfec",
							Name = "Administrator",
						...
						new
						{
							...
							ConcurrencyStamp = "c605912c-903b-4cff-af51-20879c004dbd",
							Name = "Talent",
						...
						new
						{
							...
							ConcurrencyStamp = "742dfd44-5602-4779-9712-77625cfde0fa",
							Name = "Uplifter",
						...
						new
						{
							...
							ConcurrencyStamp = "792e43cc-4773-4241-92c0-3625f92d286c",
							Name = "MediaAssistant",
						...
						new
						{
							...
							ConcurrencyStamp = "05b490d6-2616-4985-8eef-53359fa633bf",
							Name = "Promoter",
						...
						new
						{
							...
							ConcurrencyStamp = "a4699416-8d7f-4f75-8951-f7faee06d9fa",
							Name = "Producer",
			...
			modelBuilder.Entity("Bizomet.Data.Entities.UserProfile", b =>
				{
					...
					b.HasIndex("PublicName")
						.IsUnique()
						.HasDatabaseName("PublicNameIndex");
