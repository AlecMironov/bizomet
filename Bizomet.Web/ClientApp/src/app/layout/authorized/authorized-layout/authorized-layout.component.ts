...
export class AuthorizedLayoutComponent {
  ...
  constructor(private menuService: MenuService, private primengConfig: PrimeNGConfig, private _router: Router, public app: AppComponent, private authenticationService: AuthenticationService) { }
