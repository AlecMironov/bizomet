...
namespace MailKitMailer.TagHelpers
{
	/// <summary>
	...
	public class MailerInlineStyleTagHelper : TagHelper
	{
		...
		/// <summary>
		/// This is the internal class for an cache entry used in distributed caches
		/// </summary>
		...
		{
			string path = Href;
			string cachekey = "MailKitMailer__InlineStyleTagHelper-" + path;
